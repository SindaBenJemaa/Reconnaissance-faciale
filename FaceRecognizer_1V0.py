...
while True:
    ...
    for encoding in encodings:
       ...
       #méthode utilisé pour calculer le taux de reconnaissance
    ...
    for ((top, right, bottom, left), name) in zip(boxes, names):
        ...
        cv2.putText(frame, str(round(confidence * 100)) + '%', (left, bottom + 20), cv2.FONT_HERSHEY_SIMPLEX, tagSize, green, 1)
